...
public class LogApplicationService {
    ...
    public List<OperationLogDTO> getAllOperationLogList() {
        List<SysOperationLogEntity> list = operationLogService.list();
        return list.stream().map(OperationLogDTO::new).collect(Collectors.toList());
    }
